...
plot_Kmkm <- NO3_km %>%
  ...
  xlab("Location of 1km restoration \n along the flowpath (km)")+
...
plot_Kmk10 + theme(text = element_text(size = 7)) + plot_Kmkm + theme(text = element_text(size = 7)) +
  ...
  plot_layout(ncol = 3, guides = "collect")+
            plot_annotation(title = 'Watershed NO3 Removal due to 1km Restoration',
                            #caption = 'Total flow path length from river 1-7 to 4-1 outlet = 50.4 Km',
                            theme = theme(title = element_text(size = 8, face = 2))) 


ggsave("Exports/1km.png", dpi=500)
```
...
plot_1kmdiff_k10 + theme(text = element_text(size = 7)) + plot_1kmdiff_km + theme(text = element_text(size = 7)) +
  plot_1kmdiff_k90 + theme(text = element_text(size = 7)) +
  plot_layout(ncol = 3, guides = "collect")+
            plot_annotation(title = 'Additional Benefit in NO3 Removal produced by 1 Km Length Restoration',
                            theme = theme(title = element_text(size = 8, face = 2)))

ggsave("Exports/1km_addBenefit.png", dpi=500)
```
