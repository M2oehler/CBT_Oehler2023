...
load1 <- 4290.59 #input load to a single first order stream (grams)
load2 <- 37795.52 #input load to a single second order stream (grams)
load3 <- 371227.69 #input load to a single third order stream (grams)
load4 <- 3548993.81 #input load to the fourth order stream (grams)

k <- 0.061 #0.0067 10th percentile
