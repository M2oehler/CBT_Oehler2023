...
NO3_Full %>%
  ...
  ggtitle("Incremental Full Restoration of the Watershed \n %NO3 Removed at the Outlet (k10)")
ggsave("Exports/Full_k10.png", dpi=500,  units="in")
...
NO3_Full %>%
  ...
  ylab("Percent NO3 Removed from the Watershed")+
  scale_x_continuous(breaks=seq(0,100,by=20),  sec.axis = sec_axis(~.*130.454/100, name = "Watershed Length Restored [km]", breaks = seq(0,135,10)))+
  ggtitle("Incremental Full Restoration of the Watershed \n %NO3 Removed at the Outlet (km)")
ggsave("Exports/Full_km.png", dpi=500,  units="in")
...
NO3_Full %>%
  ...
  ylab("Percent NO3 Removed from the Watershed")+
  scale_x_continuous(breaks=seq(0,100,by=20),  sec.axis = sec_axis(~.*130.454/100, name = "Watershed Length Restored [km]", breaks = seq(0,135,10)))+
  ggtitle("Incremental Full Restoration of the Watershed \n %NO3 Removed at the Outlet (k90)")
ggsave("Exports/Full_k90.png", dpi=500,  units="in")
```
